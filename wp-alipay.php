...
*/
/*  Copyright 2012-2014  爱主题  (Homepage:http://www.iztwp.com/  E-Mail:whyun@vip.qq.com)  */
...
function alipay_menu() {
	...
	if(function_exists('add_submenu_page')) {
		...
		add_submenu_page(plugin_dir_path(__FILE__).'/alipay-settings.php', '订单查询', '订单查询',  'administrator','alipay_list', 'alipay_render_list_page');
	}
}
?>
<?php
